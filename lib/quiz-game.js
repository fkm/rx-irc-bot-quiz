...
/**
 * @type {Object}
 * @property {string} defaults.prefix='[Qz]'
 * @property {number} defaults.startDelay=10000
 * @property {number} defaults.questionDelay=5000
 * @property {number} defaults.hintInterval=5000
 * @property {boolean} defaults.moderated=true
 * @property {boolean} defaults.hintsUseCache=false
